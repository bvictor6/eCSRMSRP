-- Table: public.srp_country
DROP TABLE IF EXISTS public.srp_country;

CREATE TABLE IF NOT EXISTS public.srp_country
(
    id uuid NOT NULL DEFAULT gen_random_uuid(),
    iso character varying(5) COLLATE pg_catalog."default",
    name character varying(80) COLLATE pg_catalog."default",
    nicename character varying(80) COLLATE pg_catalog."default",
    iso3 character varying(5) COLLATE pg_catalog."default",
    numcode smallint,
    phonecode numeric(5,0),
    CONSTRAINT srp_country_pkey PRIMARY KEY (id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.srp_country
    OWNER to postgres;



INSERT INTO srp_country (iso, name, nicename, iso3, numcode, phonecode) VALUES
